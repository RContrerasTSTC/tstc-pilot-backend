...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-VYY5LCG6.js");
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: () => import("./Roles-FJ2SZHUL.js"),
      ...
      },
      {
        ...
        Component: () => import("./Providers-JTVQX6XS.js"),
      ...
      },
      {
        ...
        Component: () => import("./EmailTemplates-TXJRE2F7.js").then((mod) => ({
      ...
      },
      {
        ...
        Component: () => import("./AdvancedSettings-YI5XGSUN.js").then((mod) => ({
