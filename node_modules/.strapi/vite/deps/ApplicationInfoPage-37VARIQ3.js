...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-4TCYCHFS.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-HNWGCX3G.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-37VARIQ3.js.map
