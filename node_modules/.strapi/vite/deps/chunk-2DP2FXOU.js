...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-3MUEASKJ.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-FZSR4SLV.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-KYSGESIZ.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-KYSGESIZ.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-KYSGESIZ.js");
...
//# sourceMappingURL=chunk-2DP2FXOU.js.map
