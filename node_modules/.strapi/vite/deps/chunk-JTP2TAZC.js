...
import {
  LimitsModal
} from "./chunk-TYI6IUJ5.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-PEVAXBGX.js";
import {
  getStageColorByHex
} from "./chunk-QV7IJDSL.js";
import {
...
} from "./chunk-L4JZUTN2.js";
import {
  useTypedSelector
} from "./chunk-LOPPMXUO.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-3J3E6MCK.js";
import {
  index
} from "./chunk-2DP2FXOU.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-IHOXBRJ7.js";
import {
  useConfig
} from "./chunk-LXKM32BI.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  ...
  reducer2,
  require_baseUniq
} from "./chunk-U2J3JZSI.js";
import {
  useDocumentActions
} from "./chunk-EZFAQ62M.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-K6KEQ3ND.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  renderAdmin
} from "./chunk-6OKZK3ZL.js";
import {
  useAIAvailability
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-EIQNNXBJ.js";
import {
  useLicenseLimits
} from "./chunk-2CNCQ5XJ.js";
import {
  Table,
  useTable
} from "./chunk-OSHZ6CAH.js";
import {
  useAdminUsers
} from "./chunk-5NRLS4UF.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-T3K4TKG4.js");
    ...
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-3KO5K6SJ.js");
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-GIWTFORL.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
function __variableDynamicImportRuntime1__2(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-TYX24UPG.js");
    case "./translations/pl.json":
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-T2Y4HTVQ.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-HDPO4C2G.js");
    case "./translations/pl.json":
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-63XM72PI.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-HQTC4MD5.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-3DMWSHCT.js");
        return {
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-6DKAIM7T.js");
    case "./translations/pl.json":
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-ZTEAEODJ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-NVNHFA47.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-4RJAYJXI.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-XFRF6BKG.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-M4VCZMNH.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-S3MB3NII.js");
          return {
...
function __variableDynamicImportRuntime3__2(path) {
  switch (path) {
    ...
    case "./translations/nl.json":
      return import("./nl.json-YOYRPY45.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-C6XE3OAY.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-CIFPBI5P.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-SQLUA56T.js");
          return {
...
//# sourceMappingURL=chunk-JTP2TAZC.js.map
