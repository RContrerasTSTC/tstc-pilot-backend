...
} from "./chunk-7ETLTG6Q.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-WSIQICE4.js";
import {
  require_pick
} from "./chunk-A3SHQ6VE.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-BJGU4M64.js";
import {
  useGetAiUsageQuery
} from "./chunk-XPQTDESA.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-MZ4GPKTN.js";
import {
  require_baseRest
} from "./chunk-VV7EI3T6.js";
import {
  HistoryProvider
} from "./chunk-2IHIAPBR.js";
import {
  useEnterprise
} from "./chunk-37BW67VR.js";
import {
  getBasename
} from "./chunk-TKXHHSNW.js";
import {
  useClipboard
} from "./chunk-NVKWRMQF.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-XG7WMYOX.js";
import {
  Layouts
} from "./chunk-IDE5V7JK.js";
import {
  Login
} from "./chunk-PF2DYCQ4.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-AAIXOL7B.js";
import {
  ConfigurationProvider
} from "./chunk-A3IAT27U.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-VJLW4426.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-BF3RLOVV.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-PHSEI6SH.js";
import {
  MemoizedInputRenderer
} from "./chunk-PXLF7EFM.js";
import {
  Form
} from "./chunk-L3PR4EFY.js";
import {
  getByteSize
...
} from "./chunk-FTMVPWFQ.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-F6P6ZVLR.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-6MPZ5T6V.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-ZAZQRF5Z.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-HJIOEEXL.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-CB6KZCAV.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-DGB3L2KH.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-DN6H5FDJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-CDIZCTML.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-62QVDHSH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-NHTRL4XU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-TBEPCCWK.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-7JPER7ZY.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-GIZPJVOB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WXTSQ6SP.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-C7ARDJPW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BCP7SQ62.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-2ENZ6EIR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-FTC2YXWV.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-7TAIEGPY.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-L5IIF7AN.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-3XQEECJ6.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-HJ43P6X3.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-VFF3L2EU.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-JOUBEJYC.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-RUCOD6KO.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-RYYX6Z33.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-KQMNWGS2.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-6IGDOE3B.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-37VARIQ3.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-AWWIE4HK.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/fi.json":
      return import("./fi.json-D5GNU6MF.js");
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-YL3DK3DC.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-YL3DK3DC.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-AURJUJJK.js");
...
//# sourceMappingURL=chunk-6OKZK3ZL.js.map
